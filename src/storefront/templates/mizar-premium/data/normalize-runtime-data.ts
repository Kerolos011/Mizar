export type MizarPremiumRuntimeData = Record<string, any>;
...
function normalizeStore(data: any, settings: any) {
  ...
  const normalizedStore = {
    ...
    template: firstText(data.templateKey, store.template, templateConfig.templateKey, "MIZAR_PREMIUM"),
    templateKey: firstText(data.templateKey, store.templateKey, templateConfig.templateKey, "MIZAR_PREMIUM"),
    templateConfig: {
      ...templateConfig,
      templateKey: firstText(templateConfig.templateKey, data.templateKey, store.template, "MIZAR_PREMIUM"),
    },
...
function normalizeHeroSlides(rawContent: any, store: any, homepage: any) {
  ...
  return [
    {
      id: "default-premium-slide",
      title: firstText(store.tagline, store.nameAr, store.name, "Mizar Premium"),
      titleEn: firstText(store.nameEn, store.tagline, store.name, "Mizar Premium"),
...
export function normalizeMizarPremiumRuntimeData(rawData: MizarPremiumRuntimeData) {
  const data = rawData || {};
